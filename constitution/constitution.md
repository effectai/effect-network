...
&nbsp;&nbsp;&nbsp; **2.2** Membership is a mandatory prerequisite to be a
...
1.1.4 A reference to writing or written includes email and any Digital Signature
(as defined in clause 1.2).

1.1.5 An obligation of a Party not to do something includes an obligation not to
allow that thing to be done.

1.1.6 A reference to this Constitution and Terms and Conditions as varied or
novated (in each case, other than in breach of the terms of this Constitution
and Terms and Conditions) from time to time.

1.1.7 References to clauses are to the clauses of this Constitution and Terms
and Conditions.

1.1.8 Any words following the terms ‘including, include, in particular, for
...
1.1.9 Unless the context otherwise requires, words in the singular shall include
the plural and in the plural shall include the singular.

1.2 In this Constitution, if not inconsistent with the context, the words and
expressions shall bear the meanings set opposite them respectively.


|| Expression: | Meaning: |
|-|------------|----------|
| 1.2.1 | **Agreement** | Means the Terms and Conditions as specified in the Constitution and agreement between any person or entity accepting the Agreement and/or participating in any capacity in the EffectDAO. |
| 1.2.2 | **Blockchain** | Also known as "Distributed Ledger Technology", means a consensus of replicated, shared and synchronized digital data geographically spread across multiple sites, countries, and institutions |
...
The Effect Dashboard describes the proposed activities of the EffectDAO and the
...
- Support the purpose of the EffectDAO as described in the Constitution and
...
The indemnity set out in this Agreement shall apply whether or not you have been
...
Membership in the EffectDAO is non-transferable. Any DAO Member who intends to
